...
- LSB 隐写术在 PNG 和 BMP 中的应用
- zlib 压缩数据
- [OpenStego](http://openstego.sourceforge.net/)
- [伪装 1.2.1](http://camouflage.unfiction.com/)
- [LSB与埃拉托斯特尼集](http://wiki.cedricbonhomme.org/security:steganography)
